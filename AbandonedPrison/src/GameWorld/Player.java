...
/**
 * Player class. Handles the creation,Movement, Inventory of a player.
 * 
...
public class Player {
   ...
   * 
   * @param rir the player is facing
   */
  ...
  public boolean playerMove(List<Room> roomList) {
    ...
    for (Door dc : currentRoom.getDoors()) {
      if (dir.equals(dc.getDirection())) {
        move(dir);
        System.out.println("Move through: " + dir + " door to " + getPlayerLocation().getX() + ","
