...
public class GameWorldItemTests { 
	...
	@Test
	public void unlockContainerTest() {
		Game game = loadHelper("GameWorldTestMap.sml");
		for(Room r : game.getRooms()) {
			for(Container container : r.getContainer()){
				if(container.getId() == 1) {
					game.unlockContainer(container, new Key("Key", 1, "TestKey", new Location(1,1)));
				}
			}
		}
	}
