...
public class ComparisonTests {
  ...
  public void roomComparisonTest1() {
    Room room1 = new Room(new Point3D(0, 0, 10), new ArrayList<AbstractWall>(),
        new AbstractItem[4][4], new Floor(new Point3D(0, 0, 0)));
    Room room2 = new Room(new Point3D(0, 0, 0), new ArrayList<AbstractWall>(),
        new AbstractItem[4][4], new Floor(new Point3D(0, 0, 0)));
  ...
  public void roomComparisonTest2() {
    Room room1 = new Room(new Point3D(0, 0, 0), new ArrayList<AbstractWall>(),
        new AbstractItem[4][4], new Floor(new Point3D(0, 0, 0)));
    Room room2 = new Room(new Point3D(0, 0, 10), new ArrayList<AbstractWall>(),
        new AbstractItem[4][4], new Floor(new Point3D(0, 0, 0)));
    PriorityQueue<Room> rooms = new PriorityQueue<Room>();
    rooms.add(room1);
    rooms.add(room2);
  ...
  public void roomComparisonTest3() {
    Room room1 = new Room(new Point3D(0, 0, 0), new ArrayList<AbstractWall>(),
        new AbstractItem[4][4], new Floor(new Point3D(0, 0, 0)));
    Room room2 = new Room(new Point3D(10, 0, 0), new ArrayList<AbstractWall>(),
        new AbstractItem[4][4], new Floor(new Point3D(0, 0, 0)));
    PriorityQueue<Room> rooms = new PriorityQueue<Room>();
    rooms.add(room1);
    rooms.add(room2);
  ...
  public void roomComparisonTest4() {
    Room room1 = new Room(new Point3D(10, 0, 0), new ArrayList<AbstractWall>(),
        new AbstractItem[4][4], new Floor(new Point3D(0, 0, 0)));
    Room room2 = new Room(new Point3D(0, 0, 0), new ArrayList<AbstractWall>(),
        new AbstractItem[4][4], new Floor(new Point3D(0, 0, 0)));
    PriorityQueue<Room> rooms = new PriorityQueue<Room>();
  ...
  public void polyComparisonTest1() {
    Polygon3D poly1 = new Polygon3D(new float[] { 2, -1, 0 }, new float[] { 1, 1, 0 },
        new float[] { 1, 1, 1 }, 3);
    Polygon3D poly2 = new Polygon3D(new float[] { 2, -1, 0 }, new float[] { 1, 1, 0 },
        new float[] { 2, 2, 2 }, 3);
  ...
  public void polyComparisonTest3() {
    Polygon3D poly1 = new Polygon3D(new float[] { 2, -1, 0 }, new float[] { 1, 1, 0 },
        new float[] { 1, 1, 1 }, 3);
    Polygon3D poly2 = new Polygon3D(new float[] { 2, -1, 0 }, new float[] { 2, 2, 1 },
        new float[] { 1, 1, 1 }, 3);
    PriorityQueue<Polygon3D> polys = new PriorityQueue<Polygon3D>();
    polys.add(poly1);
    polys.add(poly2);
  ...
  public void polyComparisonTest4() {
    Polygon3D poly1 = new Polygon3D(new float[] { 2, -1, 0 }, new float[] { 2, 2, 1 },
        new float[] { 1, 1, 1 }, 3);
    Polygon3D poly2 = new Polygon3D(new float[] { 2, -1, 0 }, new float[] { 1, 1, 0 },
        new float[] { 1, 1, 1 }, 3);
    PriorityQueue<Polygon3D> polys = new PriorityQueue<Polygon3D>();
