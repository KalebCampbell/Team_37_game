...
/**
 * Respresents one object in a 3D environment. Holds all of the polygons for the object.
 *
 * @author Joel Harris
 */
public class Mesh {
  ...
  /**
   * Converts this meshes polygons into YAxisPolygon's which uses a compareTo method based on the
   * polygons Y axis.
   */
  ...
  /**
   * Uses the compareTo method in Polygon3D to order the Polygons3D using a PriorityQueue.
   * 
