...
public class Polygon3D implements Comparable<Polygon3D>, Cloneable {
  ...
  /**
   * Uses the z value associated with each x value to calculate where the x value would be in 3D
   * space.
   * 
   * @return the x points
   */
  ...
  /**
   * Uses the z value associated with each y value to calculate where the y value would be in 3D
   * space.
   * 
   * @return the y points
   */
  ...
  public String toString() {
    ...
    return str.concat("3dpoints: \nx1: " + xPoints3D[0] + " y1: " + yPoints3D[0] + " z1: "
        + zPoints[0] + "\nx2: " + xPoints3D[1] + " y2: " + yPoints3D[1] + " z2: " + zPoints[1]
        + "\nx3: " + xPoints3D[2] + " y3: " + yPoints3D[2] + " z3: " + zPoints[2]);
  }
